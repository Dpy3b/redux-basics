...
const ReduxWithReduxThunk = () => {
	...
	// опционально для addCash и getCash можно было бы сделать экшн-криэйторы, так удобнее как в addCustomer и removeCustomer
	...
	return (
		<div className='App'>
			...
			<div style={{ fontSize: '20px', marginBottom: '20px' }}>
				На нашем банковском счёте сейчас: {cash} рублей
			</div>
			<div style={{ display: 'flex', justifyContent: 'center' }}>
				<button
					className='button'
					onClick={() => addCash(Number(prompt('Введите сумму для пополнения')))}
				>
					Пополнить счёт
				</button>
...
export default ReduxWithReduxThunk;
